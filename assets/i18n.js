...
window.YUAN_I18N = {
  en: {
    ...
    /* ledger */
    'q.calc':'Your landed cost', 'q.qty':'How many do you want?',
    'q.total':'Total landed at your shop', 'q.perunit':'per',
    'q.calculating':'Working it out…',
    'q.confirmed':'confirmed', 'q.estimated':'estimated',
    'q.estnote':'Lines marked estimated use a published rate, not a quote obtained for your own shipment. Every one of them is named above, so nothing is hidden inside a round number.',
    'q.allconfirmed':'Every figure in this total is a rate Mirza Javaid Iqbal has confirmed himself.',
    'q.belowmoq':'Below the minimum order of',
    'q.freightnote':'How the shipping volume was worked out',
    'q.vol':'Volume', 'q.volpiece':'per piece',
    'q.signin':'Sign in to place an order',
    'q.needverify':'Your account is waiting for approval before a first order',
    'q.addbasket':'Add to basket', 'q.added':'Added to your basket',
    'q.openfree':'This calculation is open to everyone. You only need an account to place the order.',
    'q.notapply':'does not apply to this product',
    'q.sharednote':'Port and clearing are charged once per container, so your order carries only its share by volume.',
    'q.market':'Selling in Pakistan now', 'q.marketvs':'You save',
    'q.marketover':'Local retail is cheaper right now',
  ...
  ur: {
    ...
    'q.calc':'آپ تک پہنچنے کی پوری قیمت','q.qty':'آپ کو کتنے چاہیے؟',
    'q.total':'آپ کی دکان پر پہنچ کر کل','q.perunit':'فی',
    'q.calculating':'حساب لگا رہے ہیں…',
    'q.confirmed':'تصدیق شدہ','q.estimated':'اندازہ',
    'q.estnote':'جن سطروں پر ”اندازہ“ لکھا ہے، اُن میں شائع شدہ شرح استعمال ہوئی ہے، آپ کی اپنی کھیپ کا لیا ہوا ریٹ نہیں۔ ہر ایک کا نام اوپر لکھا ہے، تاکہ کوئی خرچہ کسی گول ہندسے میں چھپا نہ رہے۔',
    'q.allconfirmed':'اِس کل میں ہر ہندسہ وہ شرح ہے جو مرزا جاوید اقبال نے خود تصدیق کی ہے۔',
    'q.belowmoq':'کم از کم آرڈر اِس سے کم نہیں ہو سکتا:',
    'q.freightnote':'کرایہ کس حجم پر لگایا گیا',
    'q.vol':'حجم','q.volpiece':'فی عدد',
    'q.signin':'آرڈر کے لیے سائن اِن کریں',
    'q.needverify':'پہلے آرڈر سے پہلے آپ کا اکاؤنٹ منظوری کا منتظر ہے',
    'q.addbasket':'ٹوکری میں ڈالیں','q.added':'ٹوکری میں ڈال دیا',
    'q.openfree':'یہ حساب سب کے لیے کھلا ہے۔ اکاؤنٹ صرف آرڈر کرنے کے لیے چاہیے۔',
    'q.notapply':'اِس چیز پر لاگو نہیں',
    'q.sharednote':'بندرگاہ اور کلیئرنگ کا خرچہ پورے کنٹینر پر ایک بار لگتا ہے، اِس لیے آپ کے آرڈر پر صرف اُس کے حجم کے حساب سے حصہ آتا ہے۔',
    'q.market':'پاکستان میں آج کی قیمت','q.marketvs':'آپ کی بچت',
    'q.marketover':'اِس وقت مقامی مارکیٹ سستی ہے',
  ...
  zh: {
    'q.calc':'到岸总成本','q.qty':'您需要多少？',
    'q.total':'送到店里的总价','q.perunit':'每',
    'q.calculating':'正在计算…',
    'q.confirmed':'已确认','q.estimated':'估算',
    'q.estnote':'标注“估算”的项目使用公开费率，而非为这批货实际取得的报价。每一项都已列明，不会把费用藏在一个整数里。',
    'q.allconfirmed':'此总价中的每一项费率，均由米尔扎·贾维德·伊克巴尔本人确认。',
    'q.belowmoq':'低于起订量：',
    'q.freightnote':'运费按什么体积计算',
    'q.vol':'体积','q.volpiece':'每件',
    'q.signin':'登录后下单',
    'q.needverify':'首次下单前，您的账号仍在等待审核',
    'q.addbasket':'加入采购单','q.added':'已加入采购单',
    'q.openfree':'此计算对所有人公开，仅下单需要账号。',
    'q.notapply':'不适用于此产品',
    'q.sharednote':'港口与清关费用按整柜收取一次，您的订单只按体积分摊其中一部分。',
    'q.market':'巴基斯坦当前售价','q.marketvs':'您可节省',
    'q.marketover':'目前当地零售价更低',
    'led.fee':'元市场服务费','led.pending':'费率待确认',
    'p.unit.piece':'件','p.unit.set':'套','p.unit.carton':'箱','p.unit.dozen':'打',
